...
public class ImageRepository {
    ...
    public Image getImageByTitle(String title, int id) {
        EntityManager em = emf.createEntityManager();
        try {
            TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.title =:title and i.id =:imageId", Image.class).setParameter("title", title).setParameter("imageId", id);
    ...
    public Image getImage(Integer imageId) {
        ...
        System.out.println("imagge===" + image);
        return image;
    }
    ...
    public String createComment(String text) {
        EntityManager em = emf.createEntityManager();
        EntityTransaction transaction = em.getTransaction();
