...
public class UserController {
    ...
    public String registration(Model model, RedirectAttributes redirectAttrs) {
        User user = new User();
    ...
    public String registerUser(User user, Model model, RedirectAttributes redirectAttrs) {
