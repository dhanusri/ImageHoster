...
public class ImageController {
    ...
    public String showImage(@PathVariable("title") String title, Model model, @PathVariable("imageId") int imageId) {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session, RedirectAttributes redirectAttrs) {
        ...
        System.out.println("imageuser===" + imageOwner);
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        System.out.println("updated image title===" + updatedImage.getTitle());
